...
import { setToggleBlocksPreview } from 'volto-hideshow-blocks/actions/toggleBlocksPreview';
...
const ToggleBlocksPreviewToolbar = (props) => {
  const intl = useIntl();
...
export default ToggleBlocksPreviewToolbar;
